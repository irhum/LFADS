...
def gen_traj(key, n_traj=40, N=50, dt=0.001, total_steps=1000):
...
def gen_spikes(key, n_traj=40, spikes_per_traj=10, base_rate=30, N=50, dt=0.001, seconds=1):
    total_steps = int(jnp.ceil(seconds/dt))
    trajs = gen_traj(key, n_traj, N, dt, total_steps)
